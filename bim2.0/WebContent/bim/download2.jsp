...
<body>
	...
	<div class="container" style="height:250px;">	
			<div>
				<input type="text" name="search" value="搜索" class="text-search2"/> 
   				<img src="${request.getContextPath()}/bim2.0/img/download/search2.png" style="margin-left:-35px;hight:15px;width:15px;"> 
	...
	<div class="container" >
				<div class="multi-col" style="text-align:center;">
					<img src="${request.getContextPath()}/bim2.0/img/download/example2.png" style="width:140px;heigth:220;"/>
					<input type="button" value="DORWA" class="dorwa-button"/>
				</div>
				<div class="multi-col" style="text-align:center;">
					<img src="${request.getContextPath()}/bim2.0/img/download/example2.png" style="width:140px;heigth:220;"/>
					<input type="button" value="DORWA" class="dorwa-button"/>
				...
				<div class="multi-col" style="text-align:center;">
					<img src="${request.getContextPath()}/bim2.0/img/download/example3.png" class="example3-img"/>
					<input type="button" value="WINDOWMASTER" class="dorwa-button"/>
				</div>
				<div class="multi-col" style="text-align:center;">
					<img src="${request.getContextPath()}/bim2.0/img/download/example3.png" class="example3-img"/>
					<input type="button" value="WINDOWMASTER" class="dorwa-button"/>
